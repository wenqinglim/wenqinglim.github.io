...
---
------------------------------
{% include button.html text="View PDF" link="/assets/wenqinglim_resume.pdf" %}
...
- Developed end-to-end pipeline for vocal source separation and pitch transcription ([GitHub](https://github.com/wenqinglim/singing_transcription), [Article](https://codingintune.substack.com/p/karaoke-chaos-part-i-multi-singer))
...
- Implement Ellis’ (2007) Beat tracking algorithm and evaluate performance on a Ballroom dataset ([GitHub](https://github.com/wenqinglim/beat_tracking))
...
- Built multi-modal pipeline integrating text, music, and video generation, to explore how generative models can be used for creative expression ([GitHub](https://github.com/wenqinglim/hum_me_a_melody) , [Article](https://codingintune.substack.com/p/sentient-machines-one-computers-dream))
...
- 1 of 3 winning teams ([LinkedIn](https://www.linkedin.com/posts/fetch-ai_the-smart-approach-activity-7209165525304725504-LHwN?))
