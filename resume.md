...
**Machine Learning & AI**
  ...
  - Deep Learning & Neural Networks (PyTorch, HuggingFace, SentenceTransformers)
  - Audio AI & Music Computing
...
English (Fluent), Chinese (Conversational)

------------------------------
### Education
**Queen Mary University of London,** School of Electronic Engineering and Computer Science [2023-2024]
- Masters of Science in Sound and Music Computing - AI and Music Data Science Stream (Distinction)

**National University of Singapore**, School of Computing [2015-2019]
- Bachelor of Science in Business Analytics (Second Upper with Honours)
- NUS Overseas Colleges 17/18 (Silicon Valley)

**Stanford University**, SCPD [2018-2019]
- Management Science and Engineering Courses

------------------------------
### Work History
**Data Scientist @ SilentEight, Singapore/UK** [Apr 2023 - Present]

Tech stack: Python, PySpark, SentenceTransformers, PyTorch, LangChain

Led Research and Development in ML applications:
- Fine-tuned large language models (LLMs) with synthetic data to improve entity matching models efficiency by 40%
- Developed explainable solutions for rule generation
- Optimized entity matching models using clustering techniques
- Reduced PySpark processing runtime by 70% with query optimization
...
- **Sales Tools and Analytics**: Build SQL queries for internal tools used by Sales teams to manage their portfolio and serve clients more effectively, saving potentially 50,000 hours of manual effort annually.
    ...
    - Write queries for Ads Performance metrics, standardize and consolidate metrics from multiple sources.
- **Process Optimization**: Build logic for internal alerts tool that helped advertisers gain access to managed support 2 weeks sooner.
...
- Built a classifier to identify cuisines based on text data, reducing human labelling and review time by 1 week for every 1,000 cuisine tags. [Article](https://link.medium.com/wMyddn8Paxb)
...
- Developed end-to-end pipeline for vocal source separation and pitch transcription ([Github Repo](https://github.com/wenqinglim/singing_transcription))
...
- Implement Ellis’ (2007) Beat tracking algorithm and evaluate performance on a Ballroom dataset ([Github Repo](https://github.com/wenqinglim/beat_tracking))
...
- Built multi-modal pipeline integrating text, music, and video generation, to explore how generative models can be used for creative expression ([Github Repo](https://github.com/wenqinglim/hum_me_a_melody))
...
- 1 of 3 winning teams ([LinkedIn Post](https://www.linkedin.com/posts/fetch-ai_the-smart-approach-activity-7209165525304725504-LHwN?utm_source=share&utm_medium=member_desktop))
- Built AI Agent using GPT4o to perform document Q&A to help insurance agents recommend policies to clients

**Omdena [Data Science for Social Good]** [2020-2021]

- Lead ML Engineer: Led a team to analyze and detect online child sexual abuse from chatroom datasets and research papers in 8 weeks.  ([Article](https://medium.com/omdena/exploring-scientific-literature-on-online-violence-against-children-via-natural-language-processing-d8765240e60a))
    - Data mining (BeautifulSoup, Selenium) and text analysis (TF-IDF, Bag of Words, Clustering, Market Basket Analysis)
- Singapore Chapter Lead: Co-led a 10-week project on uncovering the impact of Covid-19 on mental health in Singapore ([Article](https://link.medium.com/osTsr1z6ckb)).
    - Mentored junior collaborators at all project stages
